...
QT_MOC_LITERAL(5, 39, 12), // "handleRevise"
QT_MOC_LITERAL(6, 52, 12) // "handleEnable"

    },
    "Programmer\0refresh\0\0populate\0handleAdd\0"
    "handleRevise\0handleEnable"
};
...
void Programmer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Programmer *_t = static_cast<Programmer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->refresh(); break;
        case 1: _t->populate(); break;
        case 2: _t->handleAdd(); break;
        case 3: _t->handleRevise(); break;
        case 4: _t->handleEnable((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Programmer::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Programmer::refresh)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Programmer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Programmer.data,
      qt_meta_data_Programmer,  qt_static_metacall, nullptr, nullptr}
};
