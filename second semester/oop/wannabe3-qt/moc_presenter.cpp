...
QT_MOC_LITERAL(3, 19, 8), // "populate"
QT_MOC_LITERAL(4, 28, 9) // "handleAdd"

    },
    "Presenter\0refresh\0\0populate\0handleAdd"
};
...
void Presenter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Presenter::refresh)) {
                *result = 0;
                return;
            }
        }
