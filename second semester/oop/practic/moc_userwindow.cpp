...
QT_MOC_LITERAL(3, 20, 8), // "populate"
QT_MOC_LITERAL(4, 29, 9), // "handleAdd"
QT_MOC_LITERAL(5, 39, 5), // "showA"
QT_MOC_LITERAL(6, 45, 12), // "handleAnswer"
QT_MOC_LITERAL(7, 58, 10), // "handleVote"
QT_MOC_LITERAL(8, 69, 12), // "handleEnable"
QT_MOC_LITERAL(9, 82, 1), // "s"
QT_MOC_LITERAL(10, 84, 13), // "increaseVotes"
QT_MOC_LITERAL(11, 98, 1) // "i"

    },
    "UserWindow\0refresh\0\0populate\0handleAdd\0"
    "showA\0handleAnswer\0handleVote\0"
    "handleEnable\0s\0increaseVotes\0i"
};
...
void UserWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->showA((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: _t->handleAnswer(); break;
        case 5: _t->handleVote((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 6: _t->handleEnable((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 7: _t->increaseVotes((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserWindow::refresh)) {
                *result = 0;
                return;
            }
        }
